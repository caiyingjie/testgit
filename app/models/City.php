...
class City extends Model
{
    ...
    public static function getCityIdByGeohash($geohash)
    {
        $geohashName = Poi::getByGeohash($geohash);
        return self::queryByCode($geohashName->city_id);
    }
    public static function queryByCode($code)
    {
        return self::factory()->call('get_city_by_code')->with($code)->result(array());
    }
}
